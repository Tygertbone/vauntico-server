  ...
  const addOns = [
    {
      ...
      description:
        "Connect additional social media platforms beyond the included ones",
    ...
    },
    {
      ...
      description:
        "Deep dive into your performance metrics with AI-powered insights",
      price: "$15/month",
  ...
  const faqs = [
    {
      ...
      answer:
        "We currently support Instagram, YouTube, TikTok, Twitter, and LinkedIn. More platforms are coming soon!",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Our AI analyzes your engagement patterns, content consistency, audience growth, and authenticity metrics to generate a dynamic trust score.",
    },
    {
      question: "Is my data secure?",
      answer:
        "Absolutely. We use bank-level encryption, comply with GDPR/POPIA, and never share your data without consent.",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {plans.map((plan) => (
            <div key={plan.id} className="relative">
              ...
              <div
                className={`bg-white/5 backdrop-blur-lg rounded-2xl p-8 border-2 relative overflow-hidden transition-all duration-300 hover:scale-105 ${
        ...
        <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {addOns.map((addOn, index) => (
              <div
                key={index}
                className="bg-white/10 rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all"
              >
