...
const roles = [
  {
    ...
    description:
      "You're a creator, founder, or solopreneur building your vision. You need proven frameworks and efficient workflows.",
  ...
  },
  {
    ...
    description:
      "You run an agency and want to resell, white-label, or integrate Vauntico into your offerings.",
  ...
  },
  {
    ...
    description:
      "You manage a team of creators and need collaborative tools, workflow automation, and scalable systems.",
    ...
    <div className="mb-16">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Your role determines which scrolls you'll access first. Don't
          worry—you can always explore other paths later.
        </p>
      </div>
        ...
        {roles.map((role) => (
          ...
          >
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <span
                className={`bg-gradient-to-r ${role.color} text-white px-3 py-1 rounded-full text-xs font-semibold`}
              >
                Begin →
              </span>
            </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-bold mb-2">
              Unlock All Scrolls with Creator Pass
            </h3>
            <p className="text-gray-600 text-sm mb-4">
              Some advanced scrolls require Creator Pass. Upgrade anytime to
              access the full library, including agency tools, CLI quickstarts,
              and exclusive implementation guides.
            </p>
            <a
              href="/creator-pass"
