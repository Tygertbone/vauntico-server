...
const TrustScoreCalculator = () => {
  ...
  const getTrustTier = (score) => {
    ...
    if (score >= 750)
      return { name: "Advanced", color: "text-blue-600", bg: "bg-blue-100" };
    if (score >= 650)
      return {
        name: "Intermediate",
  ...
  const calculateScore = () => {
    ...
    if (!formData.followers || parseInt(formData.followers) < 0)
      newErrors.followers = "Please enter valid follower count";
    if (!formData.engagement)
      newErrors.engagement = "Please select engagement level";
    if (!formData.content)
      newErrors.content = "Please select content frequency";
    if (!formData.verification)
      newErrors.verification = "Please select verification level";
    ...
    setTimeout(() => {
      ...
      const engagement = engagementLevels.find(
        (e) => e.id === formData.engagement,
      );
      const content = contentFrequencies.find((c) => c.id === formData.content);
      const verification = verificationLevels.find(
        (v) => v.id === formData.verification,
      );
      ...
      setResults({
        ...
        breakdown: {
          platform: {
            name: platform.name,
            score: Math.round(platform.weight * 100 * 0.3),
          },
          followers: {
            count: followers,
            score: Math.round(followerScore * 0.25),
          },
          engagement: {
            name: engagement.label,
            score: Math.round(engagement.score * 0.25),
          },
          content: {
            name: content.label,
            score: Math.round(content.score * 0.15),
          },
          verification: {
            name: verification.label,
            score: Math.round(verification.score * 0.05),
          },
        },
  ...
  const generateRecommendations = (score, tier) => {
    ...
    if (score < 500) {
      recommendations.push({
        ...
        description:
          "Post regularly and engage with your audience to build momentum",
      });
      recommendations.push({
        icon: Users,
        title: "Grow Your Following",
        description:
          "Collaborate with other creators and use relevant hashtags",
      });
    }
    ...
    if (score >= 750) {
      recommendations.push({
        ...
        description:
          "Your high trust score opens doors to premium opportunities",
      });
      recommendations.push({
        icon: Zap,
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Calculate credibility in 60 seconds. Build trust, automate
            workflows, monetize faster.
          </p>
        ...
        {currentStep === 1 && (
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <h2 className="text-2xl font-bold mb-6 text-center">
              Tell us about your creator presence
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {errors.platform && (
                  <p className="text-red-600 text-sm mt-1">{errors.platform}</p>
                )}
              </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {verificationLevels.map((level) => (
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, verification: level.id })
                      }
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 text-center">
            <div className="mb-8">
              ...
              <h2 className="text-2xl font-bold mb-4">
                Analyzing Your Creator Trust Score
              </h2>
              <p className="text-gray-600 mb-6">
                Our AI is analyzing your platform presence, engagement patterns,
        ...
        {currentStep === 3 && results && (
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="text-center mb-8">
              ...
              <div className="mb-8">
                <div
                  className={`inline-flex items-center px-6 py-3 rounded-full ${results.tier.bg} ${results.tier.color} font-bold text-2xl mb-4`}
                >
                ...
                <p className="text-gray-600">
                  Your trust score puts you in the top{" "}
                  {Math.round((1 - results.score / 1000) * 100)}% of creators
                </p>
              </div>
              ...
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-4 text-center">
                  Recommendations to Grow Your Trust Score
                </h3>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Our algorithms analyze multiple factors to calculate your
                    creator credibility
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Scores update based on your latest performance and
                    engagement
                  </p>
                </div>
              </div>
