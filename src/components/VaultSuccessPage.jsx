...
const VaultSuccessPage = () => {
  ...
  const notionEmbedUrl =
    import.meta.env.VITE_NOTION_EMBED_URL ||
    "https://classy-uranium-c6b.notion.site/Vauntico-Prompt-Vault-Founders-Edition-26a81beec93980c88b4ec6eefe61082c?source=copy_link";
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-2xl mx-auto">
            You've unlocked the vault of infinite possibilities. Welcome to the
            inner circle of visionaries who dare to dream bigger.
          </p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-center space-x-3 text-yellow-800">
                ...
                <p className="text-lg font-semibold">
                  Sacred Knowledge: Bookmark this page for lifetime access to
                  your vault and future updates!
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      <section className="bg-white py-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Dive deep into your prompts and witness the alchemy of
            transformation. We'll continue adding sacred knowledge and updates
            to your vault.
          </p>
