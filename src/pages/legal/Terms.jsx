    ...
    <div className="min-h-screen bg-white py-20 px-6">
      <div className="max-w-4xl mx-auto prose prose-slate">
        <div className="space-y-6">
          ...
          <p className="text-slate-600"><strong>Last Updated: December 21, 2024</strong></p>
          
          <h2 className="text-2xl font-bold">1. Acceptance of Terms</h2>
          <p>By accessing or using Vauntico ("the Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the Service.</p>
          
          <h2 className="text-2xl font-bold">2. Description of Service</h2>
          <p>Vauntico provides an AI-powered platform for creators, offering:</p>
          <ul>
          ...
          <p>The Service is currently in private beta. By joining the waitlist or beta program:</p>
          <ul>
            <li>You acknowledge the Service may contain bugs or incomplete features</li>
          ...
          <ul>
            <li>Vauntico and all related trademarks, logos, and content are owned by Vauntico</li>
            <li>The Service's source code, algorithms, and design are protected by copyright</li>
          ...
          <ul>
            ...
            <li>You grant us a license to host, store, and display your content</li>
          ...
          <ul>
            ...
            <li>You consent to data processing as required to provide the Service</li>
            <li>See our Privacy Policy for detailed information</li>
          </ul>
          
          <h2 className="text-2xl font-bold">10. Third-Party Services</h2>
          <ul>
            <li>The Service integrates with third-party platforms (Stripe, Paystack, etc.)</li>
          ...
          <ul>
            ...
            <li>We are not liable for losses due to service interruptions, data loss, or security breaches</li>
            <li>Some jurisdictions do not allow liability limitations; in those cases, our liability is limited to the extent permitted by law</li>
          </ul>
          
          <h2 className="text-2xl font-bold">14. Indemnification</h2>
          <p>You agree to indemnify and hold harmless Vauntico, its officers, directors, and employees from any claims, damages, or expenses arising from:</p>
          <ul>
          ...
          <p>These Terms are governed by the laws of South Africa, without regard to conflict of law provisions.</p>
          
          <h3 className="text-xl font-semibold">15.2 Arbitration</h3>
          <p>Any disputes will be resolved through binding arbitration in Pretoria, South Africa, except for:</p>
          <ul>
          ...
          <ul>
            ...
            <li>Material changes will be notified via email or Service notification</li>
          ...
          <p>These Terms constitute the entire agreement between you and Vauntico.</p>
          ...
          <p>We may assign these Terms; you may not assign without our consent.</p>
          
          <h3 className="text-xl font-semibold">17.5 Force Majeure</h3>
          <p>We are not liable for failures due to circumstances beyond our control.</p>
          ...
          <p><strong>By using Vauntico, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</strong></p>
          
          <p className="italic"><strong>Ubuntu Spirit: "We live by what we give."</strong></p>
        </div>
      </div>
    </div>
  );
