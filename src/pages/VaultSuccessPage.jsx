        ...
        <div className="relative z-10 px-6 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div
                className={`transition-all duration-1000 ${showSuccess ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
              >
                ...
                <p className="text-xl text-gray-300 mb-6 leading-relaxed">
                  Your ascension begins now. Premium tools, curated workflows,
                  <br />
            ...
            <div
              className={`card bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border border-purple-500/30 mb-12 transition-all duration-1000 ${showSuccess ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            >
            ...
            {/* Next Steps */}
            <div
              className={`transition-all duration-1000 delay-500 ${showSuccess ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            >
              ...
              <div className="vault-gradient rounded-2xl p-8 text-center text-white">
                ...
                <p className="text-xl mb-8 opacity-90">
                  Join 2,500+ creators who've ascended with Creator Pass.
                  <br />
