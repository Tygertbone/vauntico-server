...
const scrolls = [
  {
    ...
    description:
      "Complete library navigation, quick-start guides, and voice guidelines.",
    excerpt:
      "Your comprehensive entry point to the Vauntico Lore Vault. Navigate the complete library, access quick-start guides, understand voice guidelines, and discover the architecture of sacred knowledge.",
    icon: "📋",
    tier: "free",
    category: "foundation",
    readTime: "10 min",
  ...
  },
  {
    ...
    description:
      "Premium subscription details, pricing tiers, and exclusive perks.",
    excerpt:
      "Discover the three covenant tiers, understand pricing models, explore exclusive perks, and learn how to ascend through the ranks of Vauntico mastery.",
    icon: "👑",
    tier: "free",
    category: "foundation",
    readTime: "8 min",
  ...
  },
  {
    ...
    description:
      "White-label offerings, revenue models, CLI commands, and agency success stories.",
    excerpt:
      "Master the art of agency partnerships with Vauntico. Learn white-label offerings, revenue models, CLI automation, client onboarding, and proven success stories from top agencies.",
    icon: "🏢",
    tier: "pro",
    category: "agency",
    readTime: "20 min",
  ...
  },
  {
    ...
    description:
      "Master the command line for agency operations, automation, and client management.",
    excerpt:
      "The complete command-line reference for agency operations. Learn essential commands, automation sequences, client management workflows, and power-user shortcuts.",
    icon: "⚡",
    tier: "pro",
    category: "agency",
    readTime: "12 min",
  ...
  },
  {
    ...
    description:
      "Deep system architecture, automation sequences, and scaling strategies.",
    excerpt:
      "The sacred knowledge of system mastery. Dive deep into Vauntico architecture, advanced automation, scaling strategies, and the rituals of legendary creators.",
    icon: "🔮",
    tier: "legacy",
    category: "advanced",
    readTime: "15 min",
...
function ScrollGallery({ role, hasPass, onSelectScroll, onBackToRoles }) {
  ...
  useEffect(() => {
    ...
    if (hasPass) {
      const storedTier =
        localStorage.getItem("vauntico_creator_pass_tier") || "starter";
  ...
  const recommendedScrolls = scrolls.filter((s) =>
    roleScrollAccess.includes(s.id),
  );
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold mb-2">
              {role.icon} {getRoleName(role.id)}{" "}
              <span className="text-gradient">Library</span>
            </h2>
            <p className="text-gray-600">
              Your curated scroll collection. {recommendedScrolls.length}{" "}
            ...
            <div
              className={`inline-flex items-center px-4 py-2 rounded-lg font-semibold ${
                userTier === "legacy"
                  ...
                  : userTier === "pro"
                    ? "bg-gradient-to-r from-purple-100 to-blue-100 text-vault-purple"
                    : userTier === "starter"
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-bold mb-2">
                Unlock Advanced Scrolls
              </h3>
              <p className="text-gray-600 mb-4">
                Get Creator Pass to access agency tools, CLI automation guides,
                and advanced implementation scrolls.
              </p>
...
function ScrollCard({ scroll, canAccess, onSelect, isRecommended }) {
  const getTierBadge = (tier) => {
    const badges = {
      ...
      pro: {
        text: "Pro",
        class: "bg-purple-100 text-vault-purple",
        icon: "💎",
      },
      legacy: {
        text: "Legacy",
        class: "bg-gradient-to-r from-yellow-100 to-orange-100 text-orange-700",
        icon: "👑",
      },
    };
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between text-xs">
        <div
          className={`px-2 py-1 rounded-full font-semibold ${tierBadge.class}`}
        >
