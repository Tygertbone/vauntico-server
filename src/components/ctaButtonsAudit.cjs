...
fs.readFile(filePath, "utf8", (err, data) => {
  ...
  console.log(
    hasOnClick ? "✅ Has onClick handler." : "⚠️ No onClick detected.",
  );
  console.log(
    hasVaultRef
      ? "✅ References vault/pass/checkout logic."
      : "⚠️ No vault-related logic found.",
  );
  console.log(
    hasEnv ? "✅ Uses environment variables." : "⚠️ No .env usage detected.",
  );
});
