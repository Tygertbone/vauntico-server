  ...
  const generateRecommendations = () => {
    ...
    if (progress.completed?.length === 0) {
      recs.push({
        ...
        description:
          "Complete the onboarding flow to unlock powerful automation commands",
    ...
    if (role?.id === "agency") {
      if (!achievements.includes("first-client")) {
        recs.push({
          ...
          title: "Agency Scroll",
          description:
            "Master client onboarding, white-label setups, and revenue models",
      ...
      if (!tier || tier.tier === "starter") {
        recs.push({
          ...
          description:
            "Get white-label rights and advanced CLI tools for agency scaling",
    ...
    if (role?.id === "solo-creator") {
      if (!achievements.includes("first-generation")) {
        recs.push({
          ...
          description:
            "Use DreamMover to create your first AI-powered landing page",
      ...
      recs.push({
        ...
        description:
          "Deep dive into advanced automation and scaling strategies",
    ...
    if (role?.id === "team-lead") {
      recs.push({
        ...
        description:
          "Set up vault sharing and collaborative workflows for your team",
    ...
    if (!tier || tier.tier === "free") {
      recs.push({
        ...
        description:
          "Access all scrolls, CLI tools, and premium features with Creator Pass",
    ...
    if (
      achievements.includes("onboarding-complete") &&
      !achievements.includes("automation-setup")
    ) {
      recs.push({
        id: "setup-automation",
        type: "action",
        ...
        description:
          "Configure automated workflows to save time and scale efficiently",
    ...
    if (progress.completed?.length >= 3 && achievements.length >= 2) {
      recs.push({
        ...
        description:
          "You're making great progress! Dive into specialized topics",
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                <div
                  className={`inline-flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-semibold ${priority.class}`}
                >
    ...
    <div className="card bg-gradient-to-br from-vault-purple/10 to-vault-blue/10 border-2 border-vault-purple/20">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-xs text-vault-purple font-semibold mb-1">
            Recommended
          </div>
    ...
    <div className="card bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200">
      <div className="flex items-start space-x-4">
        ...
        <div className="flex-1">
          ...
          <button className="btn-primary text-sm">{nextStep.action} →</button>
        </div>
      </div>
    </div>
  );
