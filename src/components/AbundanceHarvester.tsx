    ...
    setTimeout(() => {
      setNodes((prev) =>
        prev.map((node) => ({
          ...
          value: node.prediction,
          prediction:
            node.prediction + (Math.random() - 0.5) * node.prediction * 0.2,
              ...
              {nodes.map((node) => (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div
                      className={`p-1 rounded-full bg-gradient-to-r ${node.color} text-white text-xs`}
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-purple-600 dark:text-purple-400">
                        {node.id === "trust"
                          ? `${node.prediction.toFixed(0)}%`
                          : node.prediction.toLocaleString()}
                      </span>
                    </div>
      ...
      >
        <div className="bg-gradient-to-r from-green-100 to-blue-100 dark:from-green-900/20 dark:to-blue-900/20 rounded-2xl p-6 border border-green-200 dark:border-green-700">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 italic max-w-2xl mx-auto">
            "Like a sacred tree, your abundance grows with each season. Nurture
            your roots, strengthen your branches, and watch your fruits multiply
