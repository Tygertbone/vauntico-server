          ...
          <div className="text-center animate-fade-in">
            <div className="relative">
              ...
              <div className="relative inline-block">
                ...
                {/* Sparkle effects */}
                <div className="absolute -top-4 -left-4 text-3xl animate-sparkle">
                  ✨
                </div>
                <div className="absolute -top-4 -right-4 text-3xl animate-sparkle delay-200">
                  ✨
                </div>
                <div className="absolute -bottom-4 -left-4 text-3xl animate-sparkle delay-400">
                  ✨
                </div>
                <div className="absolute -bottom-4 -right-4 text-3xl animate-sparkle delay-600">
                  ✨
                </div>
              </div>
  ...
  return (
    <div className="absolute inset-0 bg-gradient-to-br from-vault-purple/20 to-vault-blue/20 backdrop-blur-sm flex items-center justify-center rounded-lg z-10">
      <div className="text-center">
        ...
        <div className="text-sm font-semibold text-vault-purple">
          Unlocking...
        </div>
      </div>
    </div>
