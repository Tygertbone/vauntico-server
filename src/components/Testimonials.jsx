  ...
  const testimonials = [
    {
      ...
      content:
        "Vauntico transformed my creator journey. The trust score helped me secure brand deals!",
      rating: 5,
      avatar: "SC",
    },
    {
      ...
      role: "YouTuber",
      content:
        "The fraud detection saved my channel from false claims. Incredible platform!",
      rating: 5,
      avatar: "MJ",
    },
    {
      ...
      content:
        "The analytics insights helped me double my engagement in just 2 months.",
      rating: 5,
      avatar: "ER",
    },
  ];
