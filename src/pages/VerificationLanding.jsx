      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Build trust, unlock opportunities, and get verified. The credibility
            boost your creator career needs.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                Brands are spending millions on influencer marketing, but 67%
                report difficulty identifying genuine creators from fake
                accounts and bots.
              </p>
              <p className="text-gray-700 mb-4 leading-relaxed">
                As a creator, you're fighting for attention in a crowded space.
                Without verification, you're losing deals to less qualified
                creators who simply look more legitimate.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Our verification service bridges this gap. We manually verify
                your identity, audience quality, and content authenticity so
                brands can work with confidence.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <div className="card bg-gradient-to-r from-vault-purple/10 to-vault-blue/10 border-2 border-vault-purple/20">
            ...
            <p className="text-xl text-gray-700 text-center leading-relaxed mb-8">
              Manual verification by real humans. We don't rely on algorithms or
              automated systems. Each creator is personally reviewed by our
              verification team.
            </p>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Government ID check and video confirmation
                </p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-3">👥</div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Original, high-quality creative work
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="card text-center">
              ...
              <a
                href="mailto:brands@vauntico.com"
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                Submit your verification application with basic information and
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                Provide government ID and complete video verification for
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                Our team manually reviews your application, audience, and
                content quality.
              </p>
              <div className="text-sm text-vault-purple font-medium">
                24-48 hours
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                Receive your verification badge and unlock exclusive
                opportunities.
              </p>
              <div className="text-sm text-vault-purple font-medium">
                Instant
        ...
        <div className="max-w-6xl mx-auto mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600 text-sm">
                Verified badge protects your reputation and prevents
                impersonation
              </p>
            </div>
            <div className="card text-center">
              ...
              <p className="text-gray-600 text-sm">
                Verified creators command 25-40% higher rates for sponsored
                content
              </p>
            </div>
            <div className="card text-center">
              ...
              <p className="text-gray-600 text-sm">
                Brands can easily find and verify you're the right fit for
                campaigns
              </p>
            </div>
            <div className="card text-center">
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <div className="vault-gradient rounded-2xl p-12 text-white text-center">
            <h2 className="text-3xl font-bold mb-6">
              Trusted by the Creator Community
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div>
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of verified creators who are landing better deals and
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <a
              href="mailto:verify@vauntico.com"
          ...
          <div className="space-y-6">
            <div className="card">
              <h3 className="text-lg font-bold mb-3">
                Is creator verification really free?
              </h3>
              <p className="text-gray-600">
                Yes! Creator verification is completely free. We believe every
                genuine creator should have access to verification tools to
                build their career and protect their brand.
              </p>
            </div>
            <div className="card">
              <h3 className="text-lg font-bold mb-3">
              ...
              <p className="text-gray-600">
                ...
                license, or national ID) and complete a short video verification
                to confirm your identity matches your documents.
              </p>
            </div>
            <div className="card">
              <h3 className="text-lg font-bold mb-3">
              ...
              <p className="text-gray-600">
                Most verifications are completed within 24-48 hours. Complex
                cases may take up to 5 business days. You'll receive email
            ...
            <div className="card">
              ...
              <p className="text-gray-600">
                If your application is rejected, we'll provide specific feedback
                and guidance on how to improve your profile for future
                verification. You can reapply after 30 days.
              </p>
            </div>
            <div className="card">
              <h3 className="text-lg font-bold mb-3">
                Can brands see my verification status?
              </h3>
              <p className="text-gray-600">
                Yes! Verified creators and brands display a verification badge
                on their profile, making it easy for potential partners to
                identify legitimate accounts at a glance.
              </p>
            </div>
          </div>
        </div>
