    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Get 200 credits for every friend who joins. They get a bonus too.
          Win-win.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        ...
        <div className="card text-center">
          <div className="text-4xl mb-2 text-vault-purple">
            {stats.creditsEarned}
          </div>
          <p className="text-gray-600 font-medium">Credits Earned</p>
        </div>
        <div className="card text-center">
          <div className="text-4xl mb-2 text-vault-blue">
      ...
      <div className="card mb-12 vault-gradient text-white">
        ...
        <p className="mb-6 opacity-90">
          Share this link with friends. When they sign up and upgrade to Creator
          Pass, you both get 200 bonus credits.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="card text-center">
            ...
            <p className="text-gray-600">
              Send your unique referral link via email, social media, or
              wherever your friends hang out.
            </p>
          </div>
          <div className="card text-center">
            <div className="w-16 h-16 vault-gradient rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
            ...
            <p className="text-gray-600">
              When they create an account using your link, they get 50 bonus
              credits to start.
            </p>
          </div>
          <div className="card text-center">
            ...
            <p className="text-gray-600">
              When they upgrade to Creator Pass, you both get 200 credits. Keep
              referring, keep earning.
            </p>
          </div>
        </div>
      </div>
            ...
            {leaderboard.map((user) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p
                      className={`font-semibold ${user.isYou ? "text-vault-purple" : ""}`}
                    >
                      {user.name}
                      {user.isYou && (
                        <span className="ml-2 text-sm text-vault-purple">
                          (You!)
                        </span>
                      )}
                    </p>
      ...
      <div className="card bg-gradient-to-r from-vault-purple/10 to-vault-blue/10 border-2 border-vault-purple/20 text-center">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <button className="btn-secondary">Share on LinkedIn 💼</button>
          <button className="btn-outline">Email Friends 📧</button>
        </div>
      </div>
      ...
      <div className="mt-12 max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          <div className="card">
            ...
            <p className="text-gray-600">
              You receive 200 credits immediately when your referral upgrades to
              Creator Pass. Their payment must be successful.
            </p>
          </div>
          <div className="card">
            ...
            <p className="text-gray-600">
              No limit! Refer as many people as you want. Every successful
              referral earns you credits.
            </p>
          </div>
          <div className="card">
            <h3 className="font-semibold mb-2">
              Can I refer myself or create fake accounts?
            </h3>
            <p className="text-gray-600">
              No. We actively monitor for fraud. Self-referrals and fake
              accounts will result in credit forfeiture and account suspension.
            </p>
          </div>
        </div>
      </div>
