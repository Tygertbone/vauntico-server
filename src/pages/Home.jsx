  ...
  const services = [
    {
      ...
      description:
        "Enterprise-grade trust scoring system that quantifies and tracks creator credibility across platforms.",
      features: [
    ...
    },
    {
      ...
      description:
        "Automated engagement optimization that analyzes audience patterns and maximizes creator-business interactions.",
      features: [
        "Audience analytics",
    ...
    },
    {
      ...
      description:
        "AI-powered content narrative generation that creates compelling stories from trust data and engagement metrics.",
      features: [
    ...
    },
    {
      ...
      description:
        "Centralized platform for aggregating and analyzing collective creator intelligence and market trends.",
      features: [
        "Market intelligence",
        "Trend analysis",
        "Creator insights",
    ...
    },
    {
      ...
      description:
        "Seamless migration of your infrastructure to enterprise-grade cloud platforms with zero downtime.",
      features: [
    ...
    },
    {
      ...
      description:
        "Infrastructure as Code with automated policy enforcement and compliance checks.",
      features: [
        "IaC automation",
        "Policy enforcement",
        "Compliance scanning",
    ...
    },
    {
      ...
      description:
        "Comprehensive monitoring with Sentry integration and Slack alerting.",
      features: [
    ...
    },
    {
      ...
      description:
        "Integrated payment processing with Paystack and Stripe scaffolding.",
      features: [
      ...
      <section className="relative overflow-hidden py-20 px-6 bg-gradient-to-br from-purple-50 via-white to-blue-50">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Enterprise-grade trust scoring for the creator economy. Build
            credibility, automate workflows, monetize faster.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                No signup required. Get your trust score in 60 seconds.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Advanced algorithms analyze your creator presence and
                credibility.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Easily share your score with brands and collaborators.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive infrastructure and creator tools designed for scale
              and reliability
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingTiers.map((tier, index) => (
              <div
                key={index}
                className={`relative bg-gray-800 rounded-2xl p-8 border ${tier.highlighted ? "border-purple-500 ring-2 ring-purple-500/20" : "border-gray-700"} hover:border-purple-400 transition-all duration-300`}
              >
                {tier.highlighted && (
      ...
      <section className="py-20 px-6 bg-gray-900/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Join thousands of creators who have transformed their businesses
              with Vauntico
            </p>
          </div>
      ...
      <section id="trust-calculator" className="py-20 px-6 bg-gray-800/50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Calculate Your Creator Trust Score
            </h2>
            <p className="text-xl text-gray-300">
              Get instant insights into your creator reputation and platform
              credibility
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-purple-900/50 to-blue-900/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of creators who trust Vauntico for their
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#services"
              className="px-8 py-4 border border-gray-600 text-white rounded-lg font-semibold hover:bg-gray-800 transition-all"
            >
              Explore Services
            </a>
          </div>
