  ...
  "audit-as-a-service": {
    ...
    commands: [
      ...
      },
      {
        ...
        template:
          "vauntico audit run --url {{URL}} --pillars all --format pdf --output {{OUTPUT}}",
        inputs: [
          {
            key: "URL",
            label: "Website URL",
      ...
      },
      {
        ...
        template:
          "vauntico audit schedule --url {{URL}} --frequency {{FREQUENCY}} --notify true",
        inputs: [
          {
            key: "URL",
            label: "Website URL",
    ...
    commands: [
      {
        ...
        template:
          'vauntico generate text --prompt "{{PROMPT}}" --style blog --length {{LENGTH}}',
        inputs: [
          {
            key: "PROMPT",
            label: "Content Topic",
            placeholder: "10 tips for productivity",
            required: true,
          },
          {
            key: "LENGTH",
      ...
      },
      {
        ...
        name: "Generate Image",
        template:
          'vauntico generate image --prompt "{{PROMPT}}" --size {{SIZE}} --style {{STYLE}}',
        inputs: [
          {
            key: "PROMPT",
            label: "Image Description",
            placeholder: "cyberpunk city at sunset",
            required: true,
          },
          {
            key: "SIZE",
            label: "Dimensions",
            type: "select",
            options: ["512x512", "1024x1024", "1920x1080"],
            required: true,
          },
          {
            key: "STYLE",
      ...
      },
      {
        ...
        template:
          'vauntico template save --name "{{NAME}}" --prompt "{{PROMPT}}" --style {{STYLE}}',
        inputs: [
          {
            key: "NAME",
            label: "Template Name",
          ...
          },
          {
            ...
            placeholder: "Weekly newsletter about...",
            required: true,
          },
          {
            key: "STYLE",
    ...
    commands: [
      {
        ...
        template:
          'vauntico agency onboard --client "{{CLIENT}}" --modules {{MODULES}} --white-label {{WHITE_LABEL}}',
        inputs: [
          {
            key: "CLIENT",
            label: "Client Domain",
          ...
          },
          {
            ...
            placeholder: "audit,workshop,distribution",
            required: true,
          },
          {
            key: "WHITE_LABEL",
      ...
      },
      {
        ...
        template:
          'vauntico audit run --url https://{{CLIENT}} --pillars all --brand "{{AGENCY}}" --output ./reports/{{CLIENT}}-audit.pdf',
        inputs: [
          {
            key: "CLIENT",
            label: "Client Domain",
      ...
      },
      {
        ...
        template:
          "vauntico agency audit-all --frequency {{FREQUENCY}} --notify-clients true",
        inputs: [
          {
            key: "FREQUENCY",
            label: "Frequency",
      ...
      },
      {
        ...
        template:
          'vauntico brand configure --name "{{AGENCY}}" --logo {{LOGO_PATH}} --colors {{COLORS_PATH}}',
        inputs: [
          {
            key: "AGENCY",
            label: "Agency Name",
          ...
          },
          {
            key: "COLORS_PATH",
            label: "Colors Config",
            placeholder: "./assets/colors.json",
            required: false,
          },
        ],
    ...
    commands: [
      {
        ...
        template:
          'vauntico agency revenue --period "{{PERIOD}}" --format {{FORMAT}} --breakdown by-client',
        inputs: [
          {
            key: "PERIOD",
            label: "Time Period",
      ...
      },
      {
        ...
        template:
          'vauntico agency report --client "{{CLIENT}}" --period "{{PERIOD}}" --email-to {{EMAIL}}',
        inputs: [
          {
            key: "CLIENT",
            label: "Client Name",
      ...
      <div className="mt-6 pt-6 border-t">
        ...
        <ul className="text-sm text-gray-600 space-y-1">
          ...
          <li className="flex items-start">
            <span className="mr-2">•</span>
            <span>
              Combine commands with shell pipes for advanced workflows
            </span>
          </li>
        </ul>
      </div>
