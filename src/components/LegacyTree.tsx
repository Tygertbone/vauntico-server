...
import { ChevronRight, Sparkles, Heart, Coins, Users, Zap, ArrowRight } from 'lucide-react'
...
const LegacyTree: React.FC<LegacyTreeProps> = ({ onBranchSelect, className = '' }) => {
            ...
            >
              <div
                ...
                style={{
                  ...
                  borderColor: animatingBranch === branch.id ? '#9333ea' : 'transparent'
                }}
              >
                {/* Gradient Overlay */}
                <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${branch.color} opacity-10`} />
                
                {/* Content */}
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-4">
                    <div className={`p-3 rounded-xl bg-gradient-to-br ${branch.color} text-white`}>
                      {branch.icon}
                    </div>
                    {branch.reward && (
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-purple-600 dark:text-purple-400 font-medium">
                      {branch.children ? `${branch.children.length} paths` : 'Final destination'}
                    </span>
