  ...
  const recommendations = [
    {
      ...
      description:
        "Post consistently and interact with your audience to boost engagement to 6%+",
      impact: "+15 points",
    },
    {
      ...
      description:
        "Post at least 3x per week on the same schedule for better consistency scores",
      impact: "+10 points",
    },
    {
      ...
      description:
        "Focus on organic growth strategies to increase follower count",
      impact: "+8 points",
    },
  ];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Get instant insights into your creator credibility and discover ways
            to improve your digital reputation
          </p>
        </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setMetrics({
                          ...metrics,
                          consistency: parseInt(e.target.value) || 0,
                        })
                      }
                      className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:border-purple-500 focus:outline-none transition-colors"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setMetrics({
                          ...metrics,
                          authenticity: parseInt(e.target.value) || 0,
                        })
                      }
                      className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:border-purple-500 focus:outline-none transition-colors"
            ...
            <div className="space-y-8">
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10">
                ...
                <div className="relative w-64 h-64 mx-auto mb-8">
                  {/* Glow Effect */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${scoreLevel.color} rounded-full blur-2xl opacity-30 animate-pulse-glow`}
                  ></div>
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <div
                      className={`mt-2 px-3 py-1 rounded-full bg-gradient-to-r ${scoreLevel.color} text-white text-sm font-medium flex items-center`}
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-green-400">
                      +{Math.round(metrics.authenticity * 0.35)} pts
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-blue-400">
                      +{Math.round(metrics.consistency * 0.25)} pts
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-purple-400">
                      +{Math.round(metrics.engagement * 5)} pts
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-orange-400">
                      +{Math.round(Math.log10(metrics.followers) * 10)} pts
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-pink-400">
                      +{Math.round(metrics.growth * 0.5)} pts
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <input
                      ...
                      value={targetScore}
                      onChange={(e) =>
                        setTargetScore(parseInt(e.target.value) || 0)
                      }
