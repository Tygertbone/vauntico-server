...
export default function Hero() {
  ...
  const currentContent =
    phaseContent[currentPhase as keyof typeof phaseContent];
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {(sacredSymbols[currentPhase as keyof typeof sacredSymbols] || []).map(
          (symbol, index) => (
            <div
              key={index}
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-2xl font-bold text-white">
                  Live Trust Creation Demo
                </h3>
              </div>
              <p className="text-gray-400">
                Watch as AI transforms your vision into a thriving creator
                ecosystem
              </p>
            </div>
        ...
        {showOracle && (
          <div className="mb-16 animate-fade-in">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">
                Reveal the credibility that flows through your creative essence
              </p>
            </div>
