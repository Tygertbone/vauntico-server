  ...
  const features = [
    {
      ...
      description:
        "Sacred ceremonies to align your team with Vauntico principles and establish spiritual coding practices.",
    },
    {
      icon: <BookOpen className="w-6 h-6" />,
      title: "JSX Purification",
      description:
        "Transform your React components into blessed, semantically pure JSX that honors the ancient ways of the web.",
    },
    {
      icon: <GitCommit className="w-6 h-6" />,
      title: "Lore-Sealing Commit Templates",
      description:
        "Document your journey with commit messages that capture the essence of your transformation.",
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Code Review Sanctuary",
      description:
        "A dedicated session where we perform deep architectural reviews and seal vulnerabilities.",
    },
  ];
      ...
      <section className="relative px-6 py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
            Transform your codebase into a spiritual sanctuary. One intensive
            session to purify, align, and transcend.
          </p>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">
                      3-hour intensive workshop session via video call
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
                    <span className="text-gray-300">
                      Complete codebase review and purification ritual
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
                    <span className="text-gray-300">
                      Custom commit templates aligned with your project's lore
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
                    <span className="text-gray-300">
                      Documentation of spiritual coding practices for your team
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">
              Each ritual designed to elevate your code to its highest form
            </p>
          </div>
      ...
      <section className="px-6 py-16 bg-gray-900/30">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">
              How we transform your code in three hours
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  We explore your codebase, understand your project's essence,
                  and identify areas for spiritual elevation.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Together, we refactor critical components, establish patterns,
                  and seal the architecture with intention.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  We create lasting documentation, commit templates, and team
                  rituals to maintain the elevated state.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <p className="text-gray-300 text-lg italic mb-4">
                  The workshop transformed not just our code, but our entire
                  approach to development. We now build with intention and
                  purpose. Every commit feels meaningful.
                </p>
