...
export default function NicheQuiz() {
  ...
  const questions = [
    {
      ...
      options: [
        {
          value: "money",
          label: "💰 Money, investing, side hustles",
          niches: ["finance", "entrepreneur"],
        },
        {
          value: "beauty",
        ...
        {
          value: "tech",
          label: "📱 Tech, gadgets, apps",
          niches: ["tech", "productivity"],
        },
        {
          value: "comedy",
          label: "😂 Comedy, skits, entertainment",
          niches: ["comedy", "entertainment"],
        },
        {
          value: "food",
          label: "🍳 Cooking, recipes, food culture",
    ...
    },
    {
      ...
      options: [
        {
          value: "making_money",
          label: "Making money or starting businesses",
          niches: ["finance", "entrepreneur"],
        },
        {
          value: "looking_good",
          label: "Looking good or dressing well",
          niches: ["beauty", "fashion"],
        },
        {
          value: "tech_help",
          label: "Phone tips or tech troubleshooting",
          niches: ["tech", "education"],
        },
        {
          value: "entertainment",
          label: "Making people laugh or storytelling",
          niches: ["comedy", "entertainment"],
        },
        {
          value: "cooking",
          label: "Cooking or food recommendations",
          niches: ["food", "lifestyle"],
        },
        {
          value: "motivation",
          label: "Motivation or personal development",
          niches: ["motivation", "lifestyle"],
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          value: "skits",
          label: "🎭 Skits & comedy videos",
          niches: ["comedy", "entertainment"],
        },
        {
          value: "tips",
          label: "💡 Tips & quick hacks",
          niches: ["finance", "productivity"],
        },
        {
          value: "vlogs",
          label: "📹 Daily vlogs & lifestyle",
          niches: ["lifestyle", "entrepreneur"],
        },
        {
          value: "motivational",
          label: "🔥 Motivational & inspirational",
          niches: ["motivation", "fitness"],
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "affiliate",
          label: "Affiliate commissions (recommend products)",
          niches: ["tech", "beauty", "finance"],
        },
        {
          value: "sponsorships",
          label: "Brand sponsorships & partnerships",
          niches: ["lifestyle", "beauty", "fitness"],
        },
        {
          value: "coaching",
          label: "Coaching or consulting services",
          niches: ["finance", "motivation", "fitness"],
        },
        {
          value: "products",
          label: "Selling my own digital products",
          niches: ["education", "entrepreneur", "tech"],
        },
        {
          value: "ads",
          label: "Ad revenue from views",
          niches: ["comedy", "entertainment", "lifestyle"],
        },
        {
          value: "mixed",
          label: "All of the above!",
          niches: ["entrepreneur", "lifestyle"],
        },
      ],
    },
  ];
  ...
  const nicheProfiles = {
    finance: {
      ...
      description:
        "Teach budgeting, investing, and money management to Africans building wealth.",
      earning_potential: "R3,000-R8,000/month",
      difficulty: "Medium",
      best_platforms: "TikTok, YouTube, Instagram",
      monetization:
        "Affiliate (banking apps, investment platforms), Courses, Coaching",
      african_angle:
        "Focus on mobile money, African investment platforms, local hustles",
      emoji: "💰",
    },
    beauty: {
      name: "Beauty & Fashion Creator 💄",
      description:
        "Share makeup tutorials, fashion tips, and product reviews for African markets.",
      ...
      african_angle:
        "Highlight local brands, melanin-friendly products, African fashion",
      emoji: "💄",
    },
    tech: {
      name: "Tech Tips Creator 📱",
      description:
        "Teach phone tips, app reviews, and tech hacks for everyday Africans.",
      earning_potential: "R2,000-R6,000/month",
      difficulty: "Easy",
      best_platforms: "TikTok, YouTube, Instagram",
      monetization:
        "Affiliate (phones, apps, accessories), Sponsored content, Courses",
    ...
    comedy: {
      ...
      description:
        "Make people laugh with skits, relatable jokes, and African humor.",
      ...
      african_angle:
        "African relatable humor, local language skits, cultural comedy",
      emoji: "😂",
    },
    entrepreneur: {
      name: "Business & Hustle Creator 🚀",
      description:
        "Share business tips, side hustle ideas, and entrepreneurship motivation.",
      earning_potential: "R3,500-R12,000/month",
      difficulty: "Hard",
      best_platforms: "YouTube, Instagram, TikTok",
      monetization:
        "Coaching, Digital products, Affiliate, Courses, Consulting",
      african_angle:
        "Local hustles, African business stories, mobile-first businesses",
      emoji: "🚀",
    },
    lifestyle: {
      name: "Lifestyle & Vlog Creator 🌟",
      description:
        "Document your life, share experiences, and build a personal brand.",
      earning_potential: "R2,000-R9,000/month",
      difficulty: "Medium",
      best_platforms: "Instagram, TikTok, YouTube",
      monetization:
        "Brand partnerships, Sponsored content, Affiliate, Ad revenue",
    ...
    education: {
      ...
      description:
        "Teach skills, share knowledge, and help others learn new things.",
      earning_potential: "R2,500-R8,000/month",
      difficulty: "Medium",
      best_platforms: "YouTube, TikTok, Instagram",
      monetization:
        "Courses, Coaching, Affiliate (learning tools), Sponsorships",
    ...
    motivation: {
      ...
      description:
        "Inspire and motivate others with personal development content.",
      earning_potential: "R2,000-R7,000/month",
      difficulty: "Easy",
      best_platforms: "Instagram, TikTok, YouTube",
      monetization:
        "Coaching, Digital products, Speaking, Affiliate (books, courses)",
      african_angle:
        "Ubuntu philosophy, African success stories, community upliftment",
      emoji: "🔥",
    },
    fitness: {
      name: "Fitness & Wellness Creator 💪",
      description:
        "Share workout routines, health tips, and fitness motivation.",
      earning_potential: "R2,500-R8,000/month",
      difficulty: "Easy",
      best_platforms: "Instagram, TikTok, YouTube",
      monetization:
        "Coaching, Meal plans, Affiliate (supplements, equipment), Brand deals",
  ...
  const calculateNiche = () => {
    ...
    // Find top niche
    const topNiche = Object.entries(nicheScores).sort(
      ([, a], [, b]) => b - a,
    )[0][0];
      ...
      <div className="bg-gradient-to-br from-purple-900 via-purple-800 to-green-900 text-white rounded-2xl p-8 shadow-2xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-green-500/20 rounded-xl p-6 border border-green-500/30">
            <p className="font-bold mb-2 text-green-300">
              🌍 Your African Angle:
            </p>
    ...
    <div className="bg-gradient-to-br from-purple-900 via-purple-800 to-green-900 text-white rounded-2xl p-8 shadow-2xl">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-purple-200">
          Answer 4 quick questions to discover your ideal creator path
        </p>
      </div>
