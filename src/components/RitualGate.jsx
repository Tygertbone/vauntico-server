...
const RitualGate = ({ onRitualComplete }) => {
  ...
  const generateSacredMantra = () => {
    ...
    const prefix = sacredPrefixes[Math.floor(Math.random() * sacredPrefixes.length)];
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6">
          ...
          {['peace', 'love', 'abundance'].map((phase, index) => (
            <div key={phase} className="flex items-center">
              <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-500 ${
                ...
                {phase === 'abundance' && <Infinity className="w-6 h-6 text-white" />}
              </div>
        ...
        <div className="text-center max-w-2xl mb-12">
          ...
          <p className="text-lg text-gray-400">
            Speak your intention, receive your sacred mantra, and join the legacy of creators building with purpose.
          </p>
        </div>
        ...
        {isRevealing && (
          <div className="w-full max-w-2xl">
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Your Sacred Mantra</h3>
