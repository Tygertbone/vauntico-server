...
### **Required Tools:**
- ✅ **PowerShell 5.1+** - Windows PowerShell (pre-installed)
- ✅ **OCI CLI** - Oracle Cloud Infrastructure CLI
- ✅ **curl** - HTTP client for testing (pre-installed)
- ✅ **plink** - SSH client (PuTTY suite, recommended)
...
✅ Instance launched: ocid1.instance.oc1..aaaaaaaaaaaabbbb
   Public IP: 152.70.45.67

✅ Instance launched: ocid1.instance.oc1..aaaaaaaaaaaccc
   Public IP: 152.70.45.68

✅ Instance launched: ocid1.instance.oc1..aaaaaaaaaaaddd
   Public IP: 152.70.45.69

✅ Instance launched: ocid1.instance.oc1..aaaaaaaaaaaeff
   Public IP: 152.70.45.70

Step 3: Deploying Services via SSH...
Deploying trust-score on 152.70.45.67...
✅ trust-score deployed successfully

Deploying vauntico-server on 152.70.45.68...
✅ vauntico-server deployed successfully

Deploying fulfillment on 152.70.45.69...
✅ fulfillment deployed successfully

Deploying legacy on 152.70.45.70...
✅ legacy deployed successfully

Step 4: Verifying Health Endpoints...
Testing trust-score health endpoint...
✅ trust-score health check passed

Testing vauntico-server health endpoint...
✅ vauntico-server health check passed

Testing fulfillment health endpoint...
✅ fulfillment health check passed

Testing legacy health endpoint...
✅ legacy health check passed
...
- ✅ **All 4 instances launched** with public IPs
...
- ✅ **All monitoring alerts** configured and functional
...
- **VM.Standard.E2.1:** ~$25-35 per instance × 4 = $100-140
