...
const ParallaxLayers: React.FC<ParallaxLayersProps> = ({
  ...
  const [layers, setLayers] = useState<Layer[]>([
    ...
    },
    {
      ...
      children: (
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-32 right-32 text-6xl opacity-20 animate-pulse">
            ✧
          </div>
          <div
            className="absolute bottom-32 left-32 text-6xl opacity-20 animate-pulse"
            style={{ animationDelay: "1s" }}
          >
            ◆
          </div>
          <div
            className="absolute top-1/3 left-1/4 text-4xl opacity-15 animate-pulse"
            style={{ animationDelay: "2s" }}
          >
            ⬟
          </div>
          <div
            className="absolute bottom-1/3 right-1/4 text-4xl opacity-15 animate-pulse"
