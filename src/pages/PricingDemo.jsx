...
function PricingDemo() {
  ...
  const creatorPassPrice = useMemo(
    () => getLocalizedPrice(PRICING.CREATOR_PASS),
    [],
  );
  const workshopKitPrice = useMemo(
    () => getLocalizedPrice(PRICING.WORKSHOP_KIT),
    [],
  );
  const auditServicePrice = useMemo(
    () => getLocalizedPrice(PRICING.AUDIT_SERVICE),
    [],
  );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <div className="text-sm space-y-2 text-gray-600">
                    ...
                    <p>
                      Price: {creatorPassPrice.formatted}/
                      {PRICING.CREATOR_PASS.period}
                    </p>
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <div className="text-sm space-y-2 text-gray-600">
                    <p>
                      Status:{" "}
                      {workshopAccess.isLoading
                        ? "Loading..."
                        : workshopAccess.hasAccess
                          ? "Unlocked ✓"
                          : "Locked ✗"}
                    </p>
                ...
                <div className="p-4 border rounded-lg">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <AccessBadge
                      hasAccess={auditAccess.hasAccess}
                      reason={auditAccess.reason}
                    />
                  </div>
                  <div className="text-sm space-y-2 text-gray-600">
                    <p>
                      Status:{" "}
                      {auditAccess.isLoading
                        ? "Loading..."
                        : auditAccess.hasAccess
                          ? "Active ✓"
                          : "Inactive ✗"}
                    </p>
                    ...
                    <p>
                      Price: {auditServicePrice.formatted}/
                      {PRICING.AUDIT_SERVICE.period}
                    </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                {[
                  ...
                  >
                    ...
                    <div
                      className={`text-xs ${item.value ? "text-green-600" : "text-gray-500"}`}
                    >
                ...
                >
                  <div className="p-6 bg-green-50 border-2 border-green-200 rounded-lg">
                    ...
                    <p className="text-gray-700">
                      This content is only visible when access is granted.
                    </p>
                  </div>
                </AccessGate>
              </div>
                    ...
                    {value.unlockConditions && (
                      <div className="col-span-2">
                        ...
                        <ul className="list-disc list-inside mt-2 space-y-1 text-gray-600">
                          {Object.entries(value.unlockConditions).map(
                            ([condition, enabled]) => (
                              <li key={condition}>
                                {condition}: {enabled ? "✅" : "❌"}
                              </li>
        ...
        {activeTab === "controls" && (
          <div className="card">
            ...
            <p className="text-gray-600 mb-6">
              Use these controls to toggle access states for testing. Changes
