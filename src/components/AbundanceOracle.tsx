...
export default function AbundanceOracle() {
  ...
  const drawLotus = (
    ...
    for (let i = 0; i < petals; i++) {
      ...
      ctx.quadraticCurveTo(petalLength * 0.5, petalLength * 0.3, 0, 0);
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center">
                    <canvas
                      ...
                      style={{
                        background:
                          "radial-gradient(circle at center, #1a1a2e, #0a0a0a)",
                      }}
                    />
                  </div>
                  ...
                  <div className="text-center p-4 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl border border-purple-400/20">
                    ...
                    <p className="text-sm text-gray-300 italic">
                      "Your future is a garden of infinite possibilities.
