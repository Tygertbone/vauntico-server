  ...
  const features = [
    {
      ...
      description:
        "Real-time verification of webhook signatures and payload integrity to ensure authentic requests only.",
    },
    {
      icon: <Lock className="w-6 h-6" />,
      title: "Replay Protection",
      description:
        "Advanced timestamp validation and nonce tracking to prevent replay attacks and duplicate processing.",
    },
    {
      icon: <FileSearch className="w-6 h-6" />,
      title: "Forensic Logging",
      description:
        "Comprehensive audit trails with cryptographic signatures for compliance and incident investigation.",
    },
    {
      icon: <Activity className="w-6 h-6" />,
      title: "Real-Time Monitoring",
      description:
        "24/7 automated monitoring with instant alerts for suspicious patterns or security anomalies.",
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Performance Analytics",
      description:
        "Track webhook latency, success rates, and system health with detailed performance metrics.",
    },
    {
      icon: <AlertTriangle className="w-6 h-6" />,
      title: "Threat Detection",
      description:
        "Machine learning-powered anomaly detection to identify and block malicious webhook attempts.",
    },
  ];
      ...
      <section className="relative px-6 py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-vauntico-gold/10 border border-vauntico-gold/30 rounded-full mb-6">
            ...
            <span className="text-sm text-vauntico-gold font-medium">
              Enterprise Security
            </span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
            Protect your webhooks with military-grade validation, forensic
            ...
            <div className="relative">
              <div className="text-center mb-8">
                ...
                <div className="flex items-baseline justify-center gap-2">
                  <span className="text-6xl font-bold text-vauntico-gold">
                    R999
                  </span>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">
                      Unlimited webhook validations and monitoring
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
                    <span className="text-gray-300">
                      90-day forensic log retention with encryption
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
                    <span className="text-gray-300">
                      Custom security rules and validation logic
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
                    <span className="text-gray-300">
                      Slack/Discord/Email alerts for security events
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 text-vauntico-gold flex-shrink-0 mt-1" />
                    <span className="text-gray-300">
                      Monthly security reports and compliance documentation
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="px-6 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-vauntico-gold mb-4">
              Security Features
            </h2>
            <p className="text-gray-300 text-lg">
              Enterprise-grade protection for your webhook infrastructure
            </p>
          </div>
      ...
      <section className="px-6 py-16 bg-gray-900/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">
              Our commitment to your security and uptime
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {slaGuarantees.map((sla, index) => (
              ...
              >
                <div className="text-3xl font-bold text-vauntico-gold mb-2">
                  {sla.metric}
                </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link to="/demo" className="text-vauntico-gold hover:underline">
                View full SLA terms
              </Link>
            </p>
          </div>
      ...
      <section className="px-6 py-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">
              From integration to protection in minutes
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Add our lightweight npm package to your project. Works with
                  Express, Next.js, Fastify, and more.
                </p>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Set up validation rules, whitelist IPs, and define your
                  security policies through our dashboard.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Watch real-time traffic, receive alerts, and review forensic
                  logs. We handle the security, you focus on building.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-900 border border-vauntico-gold/20 rounded-xl p-6">
              ...
              <p className="text-gray-400">
                Secure Stripe, PayPal, and payment gateway webhooks with
            ...
            <div className="bg-gray-900 border border-vauntico-gold/20 rounded-xl p-6">
              ...
              <p className="text-gray-400">
                Protect critical business logic triggered by third-party service
                webhooks.
              </p>
            </div>
            ...
            <div className="bg-gray-900 border border-vauntico-gold/20 rounded-xl p-6">
              ...
              <p className="text-gray-400">
                Validate order updates, shipping notifications, and inventory
                sync webhooks.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <p className="text-gray-300 text-lg italic mb-4">
                  Vauntico Audit stopped three attack attempts in our first
                  week. The forensic logs helped us identify a compromised API
                  key before any damage was done. Worth every penny.
                </p>
