...
const Dashboard = () => {
  ...
  const [activities] = useState([
    ...
    },
    {
      ...
      description:
        "Your engagement rate dropped 12% this week. Consider posting more consistently.",
      time: "6 hours ago",
    ...
    },
    {
      ...
      description:
        "Our system blocked 3 suspicious activities on your account this week.",
      time: "1 day ago",
    ...
    },
    {
      ...
      description:
        "You've posted consistently for 30 days straight! Keep it up!",
      time: "2 days ago",
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white/95 backdrop-blur-lg rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                    <Link
                      to="/profile"
                      className="block px-4 py-3 text-gray-700 hover:bg-gray-100 transition-colors rounded-t-lg"
                    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Monitor your trust score, engagement metrics, and growth analytics
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div
                    className={`px-2 py-1 rounded-full bg-gradient-to-r ${scoreColor} text-xs font-medium`}
                  >
                  ...
                  {metrics.map((metric, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div
                          className={`flex items-center text-sm ${metric.change > 0 ? "text-green-400" : "text-red-400"}`}
                        >
                          {metric.change > 0 ? (
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10">
                ...
                <div className="space-y-4">
                  {activities.map((activity) => (
                    <div
                      key={activity.id}
                      className={`flex items-start space-x-3 p-4 rounded-lg ${activity.color}`}
                    >
