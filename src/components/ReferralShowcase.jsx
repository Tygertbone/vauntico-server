    ...
    <div className="space-y-6">
      ...
      <div className="card bg-gradient-to-br from-vault-purple via-vault-blue to-vault-cyan text-white">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold mb-2">
            Share the Magic, Earn the Rewards
          </h2>
          <p className="text-lg opacity-90 mb-6">
            Get up to <span className="font-bold text-2xl">15% commission</span>{" "}
            on every referral
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card text-center">
          ...
          <div className="text-3xl font-bold text-vault-purple mb-1">
            {shareStats.clicks}
          </div>
      ...
      <div className="card">
        ...
        <div className="mt-6 p-4 bg-vault-purple/10 rounded-lg">
          <p className="text-sm text-gray-700">
            <strong>💡 Pro Tip:</strong> Referrals earn you recurring commission
        ...
        <div className="space-y-3">
          {[
            ...
            >
              ...
              <div className="text-right">
                <p className="font-bold text-vault-purple text-lg">
                  R{leader.earnings.toLocaleString()}
                </p>
