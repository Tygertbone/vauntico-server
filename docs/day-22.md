...
day: 22
phase: monetization
title: "Affiliate Marketing Setup: Your First Income Stream"
duration: "60 minutes"
objective: "Set up affiliate accounts and make your first commission within 7 days"
---

# Day 22: Affiliate Marketing Setup 🔗

## YOUR FIRST INCOME STREAM STARTS TODAY
...
- Get paid for recommendations you'd make anyway

**Today: By the end of this lesson, you'll have affiliate links ready to share.**

---

## 🎯 How Affiliate Marketing Works

**Step 1:** You join an affiliate program (free)  
**Step 2:** You get a unique tracking link  
**Step 3:** You share that link with your audience  
**Step 4:** Someone clicks and buys  
...
- 10 sign-ups = R500-1,000

**No inventory. No customer service. No hassle.**
...
- Sign up: tymebank.co.za/partners
...
- Examples: Recharge.com, JumiaPay
...
**✅ Active social media account** (100+ followers)  
**✅ Regular posting** (3+ videos per week)  
**✅ Relevant content** (your niche matches their product)  
**✅ Real engagement** (comments, not just views)
...
- "I'm excited to recommend [product] because [genuine reason]"

**Most programs approve within 1-3 days.**
...
💰 Best Investment App (EasyEquities) ← Affiliate link
📱 My Crypto Wallet (Luno) ← Affiliate link
📘 Free Money Guide (Download) ← Lead magnet
📲 WhatsApp Community (Join) ← Community link
```
...
**Not spammy when it's in context.**
...
**You:** "I use EasyEquities! It's beginner-friendly and you can start with R50. Link in my bio if you want to check it out!"
...
## 🌍 Real African Example: Kofi's Affiliate Journey
...
- Result: 12 more sign-ups = R1,200
...
**His lesson:** "I recommend products I actually use. People feel that authenticity."

---

## ⚠️ Affiliate Marketing Mistakes to Avoid

❌ **Promoting products you've never used** → People can tell  
✅ **Only promote what you use and trust**

❌ **Link in every video** → Looks desperate/spammy  
✅ **Natural mentions (80% value, 20% promo)**

❌ **No disclosure** → Illegal in some places, breaks trust  
✅ **Disclose: "This is an affiliate link, I earn a small commission"**

❌ **Giving up after 1 week** → Affiliates need consistency  
✅ **Promote for 4+ weeks before judging results**

❌ **Too many affiliate products** → Confuses audience  
✅ **Pick 2-3 main products to focus on**

---

## ✅ Day 22 Action Checklist

- [ ] Chose 2-3 affiliate programs relevant to my niche
- [ ] Applied to affiliate programs (completed applications)
- [ ] Set up Linktree/Beacons account
- [ ] Added affiliate links to Linktree
- [ ] Updated bio to mention "Links in bio"
- [ ] Planned 3 affiliate content ideas (tutorial, review, results)
- [ ] Filmed first affiliate promo video (post tomorrow!)
- [ ] Shared in WhatsApp: "Day 22 ✅ Affiliate links are LIVE! First commission incoming! 💰🔗"
...
- How to make R5,000+ from ONE product

**Passive income while you sleep = the dream. Tomorrow it becomes real.** 📘
