  ...
  CREATOR_PASS: {
    tiers: {
      starter: {
        ...
        idealFor: [
          "Beginners taking first steps",
          "Building portfolio consistency",
      ...
      legacy: {
        ...
        localizedPrices: {
          ZAR: {
            yearlyPrice: 24990,
            localizedYearlyPrices: { ZAR: "R249,900" },
          },
          USD: {
            yearlyPrice: 24990,
            localizedYearlyPrices: { USD: "$24,990" },
          },
        },
        features: [
...
export const getApproximatePrice = (
  price,
  fromCurrency = "ZAR",
  toCurrency = "USD",
) => {
