          ...
          {scrolls.map((scroll) => {
            ...
            return (
              <div key={scroll.id} className="relative">
                {isShaking && (
                  <LockShakeAnimation
                    onAnimationEnd={() => setShakingScrollId(null)}
                  />
                )}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card">
        ...
        <div className="mt-2 text-xs text-gray-500">Credits reset monthly</div>
      </div>
      ...
      <div className="card bg-gradient-to-br from-vault-purple/10 to-vault-blue/10">
        ...
        <button onClick={onUpgrade} className="btn-primary w-full text-sm py-2">
          Upgrade Tier
        </button>
      </div>
      ...
      <div className="card">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div
            className="bg-gradient-to-r from-vault-purple to-vault-blue h-2 rounded-full"
            style={{ width: "25%" }}
          ></div>
        </div>
      </div>
...
export function TierComparisonPage({ onSelectTier }) {
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <TierComparison currentTier="free" onSelectTier={onSelectTier} />
    </div>
  );
}
