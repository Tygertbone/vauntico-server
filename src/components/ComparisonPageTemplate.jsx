    ...
    <>
      ...
      {seo && (
        <SEOHead
          ...
          canonicalUrl={
            seo.canonicalUrl ||
            `https://vauntico.com${window.location.pathname}`
          }
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    <th className="text-left py-4 px-6 bg-gray-50 font-semibold">
                      Feature
                    </th>
                    <th className="text-center py-4 px-4 bg-gray-50 font-semibold">
                      {competitorName}
                    </th>
                    ...
                    >
                      ...
                      <td className="text-center py-4 px-4">
                        <div className="flex flex-col items-center">
                          <span
                            className={`text-3xl ${feature.competitor.color}`}
                          >
                      ...
                      <td className="text-center py-4 px-4 bg-gradient-to-br from-vault-purple/5 to-vault-blue/5">
                        <div className="flex flex-col items-center">
                          <span
                            className={`text-3xl ${feature.vauntico.color}`}
                          >
                ...
                <div className="card">
                  <h3 className="text-2xl font-bold mb-4 flex items-center gap-2">
                    <span className="text-3xl">
                      {whoShouldChoose.competitor.icon}
                    </span>
        ...
        <section className="py-20 bg-gradient-to-br from-vault-purple via-vault-blue to-vault-cyan text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join 2,500+ creators who switched from {competitorName} and never
              looked back.
            </p>
            <Link
              to="/pricing"
            ...
            <p className="text-sm mt-6 opacity-75">
              14-day free trial • No credit card required • Switch in minutes •
              Export from {competitorName} included
            </p>
          </div>
        </section>
      </div>
