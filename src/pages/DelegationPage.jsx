    ...
    <div className="bg-black text-white min-h-screen px-6 py-12">
      <header className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-gray-300">
          ...
          workflows, and scale your impact.
        </p>
      </header>
      ...
      <section className="bg-gray-900 p-6 rounded-lg mb-12">
        ...
        <p className="text-gray-300 mb-4">
          Assign tasks to AI agents for transcription, research, prompt
          generation, and automation. Treat them like specialists.
        </p>
      ...
      <section className="bg-gray-900 p-6 rounded-lg mb-12">
        ...
        <p className="text-gray-300 mb-4">
          Use pre-built templates to assign tasks to agents like Cursur, GitHub
          Copilot, or your own AI stack.
        </p>
      ...
      <section className="bg-gray-900 p-6 rounded-lg">
        <h2 className="text-2xl font-semibold text-vauntico-gold mb-4">
          🧠 Orchestrate Like a Founder
        </h2>
        <p className="text-gray-300 mb-4">
          You’re not just using AI — you’re leading it. Assign roles, set goals,
