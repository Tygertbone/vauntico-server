...
import {
  checkoutCreatorPass as paystackCheckout,
...
function CreatorPass() {
  ...
  const handleSubscribe = async (tier) => {
    ...
    try {
      ...
      const userEmail =
        localStorage.getItem("user_email") || "customer@vauntico.com";
    ...
    <>
      ...
      <StructuredData
        ...
        data={{
          ...
          description:
            "AI-powered content creation platform with three tiers: Starter, Pro, and Legacy",
          offers: [
            {
              "@type": "Offer",
              name: "Starter",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            Unlock the Vault. Ascend the Tiers.
            <br />
            <span className="text-gradient">Scale Your Legacy.</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
            Most platforms sell subscriptions. Vauntico offers{" "}
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-2">
              Join 2,500+ Creators Scaling Their Legacy
            </h2>
            <p className="text-gray-600">
              See what they're saying about their ascension
            </p>
          </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            A tiered gateway to tools, rituals, and revenue systems that scale
            with your soul.
          </p>
                ...
                <div className="flex flex-col items-center mb-3">
                  ...
                  {getApproxForTier("starter", billingCycle) && (
                    <span className="text-xs text-gray-400 mt-1">
                      ≈ {getApproxForTier("starter", billingCycle).formatted}/
                      {billingCycle === "yearly" ? "year" : "month"}
                    </span>
                  )}
                </div>
                <p className="text-sm italic text-gray-600 mb-6">
                  For the builder taking their first sacred steps
                </p>
              </div>
              ...
              <div className="text-center mb-4">
                ...
                <div className="flex flex-col items-center mb-3">
                  ...
                  {getApproxForTier("pro", billingCycle) && (
                    <span className="text-xs text-gray-400 mt-1">
                      ≈ {getApproxForTier("pro", billingCycle).formatted}/
                      {billingCycle === "yearly" ? "year" : "month"}
                    </span>
                  )}
                </div>
                <p className="text-sm italic text-gray-600 mb-6">
                  For the creator who's tasted freedom and wants dominion
                </p>
              </div>
              ...
              <div className="text-center mb-4">
                ...
                <div className="flex flex-col items-center mb-3">
                  ...
                  {getApproxForTier("legacy", billingCycle) && (
                    <span className="text-xs text-gray-400 mt-1">
                      ≈ {getApproxForTier("legacy", billingCycle).formatted}/
                      {billingCycle === "yearly" ? "year" : "month"}
                    </span>
                  )}
                </div>
                <p className="text-sm italic text-gray-600 mb-6">
                  For the oracle who builds systems that outlive them
                </p>
              </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-center text-gray-600 mb-8">
            Ascend anytime. Your credits, scrolls, and vault access scale with
            you.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {upgradePath.map((path, index) => (
              <div
                key={index}
                className="card text-center hover:border-vault-purple transition-all"
              >
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <div className="card hover:border-vault-purple transition-all">
              ...
              <p className="text-gray-600">
                Yes! Upgrade anytime via CLI or dashboard. Credits are prorated
                and rolled over, scroll access expands instantly, and support
                tier adjusts automatically.
              </p>
            </div>
            <div className="card hover:border-vault-purple transition-all">
              <h3 className="font-semibold text-lg mb-2">
              ...
              <p className="text-gray-600">
                We accept all major credit cards, PayPal, and regional payment
                methods. Pricing is automatically localized to ZAR or USD based
                on your location.
              </p>
            </div>
            <div className="card hover:border-vault-purple transition-all">
              ...
              <p className="text-gray-600">
                All unused credits roll over when you ascend. Pro tier allows
                rollover up to 1,000 credits, while Legacy tier offers unlimited
                rollover.
              </p>
            </div>
            <div className="card hover:border-vault-purple transition-all">
              ...
              <p className="text-gray-600">
                Scrolls are Vauntico's codified rituals—pre-built workflows,
                templates, and automation sequences that scale your creative
                output. Higher tiers unlock more scrolls.
              </p>
            </div>
            <div className="card hover:border-vault-purple transition-all">
              <h3 className="font-semibold text-lg mb-2">
              ...
              <p className="text-gray-600">
                Yes! All tiers include a 14-day trial period. Cancel anytime
                within the trial and you won't be charged.
              </p>
            </div>
            <div className="card hover:border-vault-purple transition-all">
              <h3 className="font-semibold text-lg mb-2">
              ...
              <p className="text-gray-600">
                Legacy members get quarterly co-creation sessions with Tyrone,
                custom scroll creation, API access, a dedicated success
                architect, and their name inscribed in the Founder's Codex.
              </p>
            </div>
          </div>
        </div>
