...
const ONBOARDING_STEPS = {
  "solo-creator": [
    ...
    },
    {
      ...
      icon: "🎨",
      command:
        'vauntico generate text --prompt "Welcome post for my audience" --style blog',
  ...
  agency: [
    ...
    },
    {
      ...
      icon: "🤝",
      command:
        'vauntico agency onboard --client "acme-corp" --modules "audit,workshop"',
    ...
    },
    {
      ...
      icon: "📊",
      command:
        "vauntico audit run --url https://client-site.com --pillars all --white-label true",
    ...
    },
    {
      ...
      icon: "🎨",
      command:
        'vauntico brand configure --name "Your Agency" --logo ./logo.png --colors ./colors.json',
      scrollReference: "AGENCY_CLI_QUICKSTART",
      optional: true,
    },
    {
      ...
      icon: "🤖",
      command:
        "vauntico audit schedule --url https://client-site.com --frequency monthly",
      scrollReference: "AGENCY_CLI_QUICKSTART",
      optional: true,
    },
  ],
  "team-lead": [
    ...
    },
    {
      ...
      additionalCommands: ["vauntico team invite --email teammate@example.com"],
        ...
        <div className="flex-1 overflow-y-auto p-8">
          ...
          {currentStep && (
            <div>
              ...
              {/* Additional Commands */}
              {currentStep.additionalCommands &&
                currentStep.additionalCommands.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-sm font-semibold text-gray-700 mb-2">
                      Additional Setup
                    </h4>
                    <div className="space-y-2">
                      {currentStep.additionalCommands.map((cmd, idx) => (
                        <div
                          key={idx}
                          className="bg-gray-900 text-green-400 p-3 rounded-lg font-mono text-sm"
                        >
                          <code>$ {cmd}</code>
                        </div>
                      ))}
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-3">
                        Learn more about this step in the{" "}
                        <strong>{currentStep.scrollReference}</strong> scroll.
                      </p>
                      <a
