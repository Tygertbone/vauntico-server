  ...
  const features = [
    {
      ...
      description:
        "Get first access to all new vault releases and premium content",
    },
    {
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Join the exclusive circle of creators who get first access to
            everything Vauntico.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="border-2 hover:border-[var(--vauntico-gold)] transition-all duration-300 hover:shadow-lg"
              >
          ...
          <Card className="shadow-2xl border-0 bg-white">
            <CardHeader className="text-center pb-6">
              ...
              <p className="text-lg text-gray-600">
                Be the first to know when Creator Pass launches. Join our VIP
