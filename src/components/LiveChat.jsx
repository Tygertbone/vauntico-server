...
export default function LiveChat() {
  ...
  const getAutoResponse = (question) => {
    const responses = {
      "📱 What apps do I need?":
        "Just free apps! Canva (design), CapCut (video editing), and Google Docs (writing). All available on Android and iOS. No paid subscriptions needed! 🎉",
      "💰 How does payment plan work?":
        "Pay R333/month for 3 months (with exit offer discount) or R349/month without discount. First payment today, then auto-charge every 30 days. Cancel anytime! 💳",
      "🛡️ Tell me about the guarantee":
        "Simple: Follow the system for 60 days. If you don't make R2,000 in month 3, email us proof of work and we refund 100%. No hassle, no questions. 🛡️",
      "🌍 Which countries supported?":
        "Designed for South Africa 🇿🇦, Nigeria 🇳🇬, Kenya 🇰🇪, and Ghana 🇬🇭, but works anywhere! Payment via M-Pesa, MoMo, bank transfer, or card. 🌍",
      "⏰ How much time per day?":
        "Just 1 hour per day! You can split it: 30 mins in the morning, 30 mins at night. Perfect for busy people with jobs or school. ⏱️",
      "🎓 Is this for beginners?":
        "Absolutely! 90% of members started with 0 followers and no experience. We teach everything step-by-step, day-by-day. Just bring your phone! 📱",
    };
    return (
      responses[question] ||
      "Great question! Let me connect you with our WhatsApp support for a detailed answer. Click the button below! 💬"
    );
  };
  ...
  useEffect(() => {
    if (
      ...
      window.VaunticoAnalytics.trackEvent
    ) {
