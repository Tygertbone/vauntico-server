 ...
 */
export const trackScrollLockClick = (
  scrollId,
  scrollTitle,
  requiredTier,
  userTier,
 ...
 */
export const trackScrollReadingTime = (
  scrollId,
  scrollTitle,
  durationSeconds,
) => {
 ...
 */
export const trackUpgradeModalOpen = (
  trigger,
  currentTier,
  scrollId = null,
) => {
 ...
 */
export const trackCLIOnboardingComplete = (
  roleId,
  roleName,
 ...
 */
export const trackComparisonCTAClick = (
  ctaText,
  ctaDestination,
  competitorName = null,
) => {
