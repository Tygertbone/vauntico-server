      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">
            When your content gets stolen, we get you paid. Fight back against
            content theft with our recovery service.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                <strong>47% of creators have had their content stolen.</strong>{" "}
                That's nearly half of all creators losing income to theft,
                plagiarism, and unauthorized use.
              </p>
              <p className="text-gray-700 mb-4 leading-relaxed">
                Content thieves operate with impunity across platforms. They
                steal your videos, articles, designs, and music, monetizing them
                without your permission while you're left powerless.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Legal action is expensive and time-consuming. DMCA takedowns are
                often ignored. We've built a recovery service that actually gets
                results and puts money back in your pocket.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <div className="text-gray-600">
                  Of creators experience content theft
                </div>
              </div>
              <div>
                ...
                <div className="text-gray-600">
                  Lost annually to content theft
                </div>
              </div>
              <div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                Document your stolen content with evidence and file a recovery
                case. No upfront costs.
              </p>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                Our team traces the theft, identifies perpetrators, and builds a
                legal case.
              </p>
              <div className="text-sm text-vault-purple font-medium">
                24-72 hours
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                We pursue legal remedies, DMCA takedowns, and payment recovery
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                Receive 70% of recovered funds. We only get paid if you get
                paid.
              </p>
              <div className="text-sm text-vault-purple font-medium">
                Instant
          ...
          <div className="vault-gradient rounded-2xl p-12 text-white text-center">
            ...
            <div className="mt-8 p-4 bg-white/10 rounded-lg">
              <p className="text-sm opacity-90">
                <strong>Compare:</strong> Lawyers charge $200-500/hour plus
                30-40% contingency. We charge 30% total with no hourly fees.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card">
              ...
              <p className="text-gray-600 mb-4">
                "Someone stole my entire course and was selling it on 5
                different platforms. Vauntico recovered $18,500 in lost revenue
                and got all copies removed."
              </p>
              <div className="text-sm text-vault-purple font-medium">
            ...
            <div className="card">
              ...
              <p className="text-gray-600 mb-4">
                "My blog posts were being copied by AI content farms. Vauntico
                tracked down 27 sites using my work and recovered $4,200 in
                damages."
              </p>
              <div className="text-sm text-vault-purple font-medium">
            ...
            <div className="card">
              ...
              <p className="text-gray-600 mb-4">
                "People were selling my art as NFTs without permission. Vauntico
                not only stopped the sales but recovered $12,800 in unauthorized
                profits."
              </p>
              <div className="text-sm text-vault-purple font-medium">
          ...
          <div className="space-y-8">
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We help you gather comprehensive evidence including
                  timestamps, original files, registration dates, and proof of
                  ownership. The stronger your case, the better our results.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Our team uses advanced digital forensics to trace the theft,
                  identify perpetrators, and document the full scope of
                  unauthorized use across platforms.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We pursue multiple legal channels simultaneously: DMCA
                  takedowns, copyright claims, cease and desist letters, and
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We negotiate settlements, recover stolen revenue, and ensure
                  you receive your rightful compensation as quickly as possible.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Don't let content thieves profit from your hard work. We'll help you
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <a
              href="mailto:recovery@vauntico.com"
          ...
          <div className="space-y-6">
            <div className="card">
              <h3 className="text-lg font-bold mb-3">
                What types of content theft do you handle?
              </h3>
              <p className="text-gray-600">
                We handle all forms of content theft including video plagiarism,
                article copying, art theft, music piracy, course content theft,
            ...
            <div className="card">
              ...
              <p className="text-gray-600">
                You'll need original files, creation dates, registration
                information (if available), and examples of the stolen content.
                Our team will guide you through gathering complete evidence.
              </p>
            </div>
            <div className="card">
              <h3 className="text-lg font-bold mb-3">
              ...
              <p className="text-gray-600">
                Simple cases can be resolved in 7-14 days. Complex cases
                involving multiple platforms or legal action may take 30-90
                days. We provide regular updates throughout the process.
              </p>
            </div>
            <div className="card">
              <h3 className="text-lg font-bold mb-3">
              ...
              <p className="text-gray-600">
                If we can't recover any funds, you pay nothing. We'll still
                attempt to get the content removed and provide you with
            ...
            <div className="card">
              ...
              <p className="text-gray-600">
                Yes! We have experience with international copyright law and
                work with legal partners worldwide to recover content across
