...
day: 12
phase: foundation
title: "Algorithm Secrets: How TikTok & Instagram Really Work"
duration: "45 minutes"
objective: "Understand the algorithm to consistently get more reach and views"
---

# Day 12: Algorithm Secrets 📈

## THE INVISIBLE FORCE THAT CONTROLS YOUR SUCCESS

**Why do some videos get 100 views while others get 100,000?**
...
- Why some creators blow up while others don't

**Master this, and you control your growth.**
...
**Your job:** Make content that makes people "dance" (watch, comment, share, save).

---

## 📊 The 7 Algorithm Ranking Factors

### **Factor #1: Watch Time (Most Important)**
...
- **Fast cuts** (change scene every 2-3 seconds)

**Real example:**  
Kofi's 15-second video: 95% watch time → 12K views  
Kofi's 3-minute video: 40% watch time → 600 views  
**Same creator, different watch times = different results.**
...
- **Relatable content** = more shares

**Real example:**  
Video with "Comment FIT for my workout plan" → 8% engagement rate → 50K views  
Video with no call-to-action → 1% engagement rate → 800 views
...
- **Pattern interrupts** (sudden change in music, scene, voice)
...
### **Factor #6: Follows from Your Video**
...
**Most videos die in Stage 1. Your job: NAIL the first 30 minutes.**
...
## 🌍 Real African Example: Amara's Algorithm Mastery
...
**Her secret:** "I stopped fighting the algorithm. I started WORKING WITH it."

---

## ⚠️ Algorithm Myths (DON'T Fall for These!)

❌ **MYTH:** "The algorithm hates me"  
✅ **TRUTH:** The algorithm is neutral. It pushes content people engage with.

❌ **MYTH:** "You need 10K followers to go viral"  
✅ **TRUTH:** Videos with 0 followers can go viral if engagement is high.

❌ **MYTH:** "Posting more = more views"  
✅ **TRUTH:** Quality > quantity. 3 great videos/week > 20 bad videos/week.

❌ **MYTH:** "The algorithm is random"  
✅ **TRUTH:** It's predictable. High engagement = more reach. Always.

❌ **MYTH:** "You need to post every day"  
✅ **TRUTH:** Consistency matters, but 3-5 quality videos/week is enough.
...
- [ ] Reviewed my top 3 performing videos - identified what worked
- [ ] Checked my TikTok/Instagram analytics (most active times)
- [ ] Set posting schedule for my peak times
- [ ] Rewrote video hooks to improve watch time
- [ ] Added engagement CTAs to increase engagement rate
- [ ] Shared in WhatsApp: "Day 12 ✅ Just learned how the ALGORITHM works! Time to hack the system (ethically) 📈💪"

---

## 🚀 Tomorrow: Day 13

**Analytics 101 - Track What Works, Double Down**

You know how the algorithm works. Tomorrow you learn how to READ YOUR DATA.

**What gets measured gets improved.**

We're tracking metrics, identifying winners, and optimizing your content strategy! 📊
...
I used to think [old belief about algorithm].

Now I know [new truth about algorithm]!

Changing my strategy to: [what you'll do differently]

Drop YOUR aha moment below! 👇
```

---

**See you tomorrow for analytics mastery! 💪🌍**
